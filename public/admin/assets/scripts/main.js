    ...
    Core.module = {
        ...
        dropDown: function (selectorTxt, isMobile) {
            ...
            $("html").on("click", function (event) {
                ...
                if (
                    !(
                        selector.hasClass(selectorTxt) ||
                        selector.parents("." + selectorTxt).length
                    )
                ) {
        ...
        menu: function () {
            ...
            $("body").on("click", function (event) {
                if ($("html.menu-active").length && $(window).width() < 800) {
                    ...
                    if (
                        !(
                            selector.hasClass("main-menu") ||
                            selector.hasClass("js__menu_mobile") ||
                            selector.parents(".main-menu").length ||
                            selector.parents(".js__menu_mobile").length
                        )
                    ) {
                        $("html").removeClass("menu-active");
                    }
        ...
        toggle: function () {
            ...
            $("body").on("click", function (event) {
                if ($(".js__toggle").hasClass("active")) {
                    ...
                    if (
                        !(
                            selector.hasClass("js__toggle_open") ||
                            selector.hasClass("js__toggle") ||
                            selector.parents(".js__toggle_open").length ||
                            selector.parents(".js__toggle").length
                        )
                    ) {
                        $(".js__toggle").removeClass("active");
                    }
    ...
    Core.func = {
        childReturnWidth: function (selector, current_width) {
            if (selector.children("li").children(".sub-menu").length) {
                ...
                selector
                    ...
                    .children(".sub-menu")
                    .each(function () {
                        var this_width = Core.func.childReturnWidth(
                            $(this),
        ...
        getChart: function () {
            $(".js__chart").each(function () {
                var selector = $(this),
                    ...
                    dataTable,
                    chart_draw,
                    themes = $(this).hasClass("black-chart")
                        ? "#1b1c1c"
                        : "#ffffff";
                if (chart) {
                    ...
                    if ($(this).hasClass("black-chart")) {
                        switch (type) {
                            case "circle":
                                ...
                                chart_draw = new google.visualization.PieChart(
                            ...
                            case "curve":
                                ...
                                chart_draw = new google.visualization.LineChart(
                                    document.getElementById(id)
                                );
                                break;
                            case "line":
                            ...
                            case "area":
                                ...
                                chart_draw = new google.visualization.AreaChart(
                                    document.getElementById(id)
                                );
                                break;
                        }
        ...
        resizeNotice: function () {
            $(".notice-popup").each(function () {
                var selector = $(this),
                    space =
                        parseInt(selector.data("space"), 10) > 0
                            ? parseInt(selector.data("space"), 10)
                            : 75,
