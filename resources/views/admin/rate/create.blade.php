    ...
    <form action="{{ route('rates.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Rate:</strong>
                    <input type="number" min="0" name="rate" placeholder="Rate/KM" class="form-control">
                    @error('rate')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="extra_rate" placeholder="Extra Rate/KM" class="form-control">
                    @error('extra_rate')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
