...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('vehicles.faq.store') }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('title') }}" name="title" placeholder="Question"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" value="{{ old('description') }}" name="description" placeholder="Answer" class="form-control">{{ old('description') }} </textarea>
                        </div>
                    </div>
